...
```{r, fig.align='center', fig.dim = c(6, 8), fig.cap="Schoenfeld Test"}
...
sum_ph$coefficients %>% 
  knitr::kable(digits = 3, caption = "Summary Table for Interaction Test (part)")
```
...
# Conclusion
brief conclusions from each section above.
